  ...
  for (const d of decisions) {
    try {
      await db.insert(signalLogTable).values({
        ...
        legacyDiagnosticScore: d.signal.score,
        runtimeEvidence: d.signal.compositeScore,
        expectedValue: d.signal.expectedValue,
        allowedFlag: d.allowed,
        admissionReason: d.rejectionReason,
        ...
        runtimeEvidenceDimensions: d.signal.dimensions,
